...
// WiFi modem pins
#define RS D0 // Request to send
#define CS D1 // Clear to send
#define CD D2 // Carrier detect
#define RI D3 // Ring
#define TR D4 // Terminal ready
#define MR D5 // Modem Ready
#define HS_DISP_CTRL D6 // Handshake display control (RS/CS LED enablement)
#define TX2 D7
#define RX2 D8
